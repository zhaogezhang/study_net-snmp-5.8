...
/*********************************************************************************************************
** 函数名称: netsnmp_register_user_domain
** 功能描述: 用来处理和 user_domain 相关的配置项数据的处理函数
** 输	 入: token - 指定的配置项 token
**         : cptr - 配置项内容
** 输	 出: 
** 全局变量: 
** 调用模块: 
...
/*********************************************************************************************************
** 函数名称: netsnmp_clear_user_domain
** 功能描述: 用来释放在 user_domain 相关的配置项数据的处理函数中申请的资源
** 输	 入: 
** 输	 出: 
** 全局变量: 
** 调用模块: 
...
/*********************************************************************************************************
** 函数名称: netsnmp_register_user_target
** 功能描述: 用来处理和 user_target 相关的配置项数据的处理函数
** 输	 入: token - 指定的配置项 token
**         : cptr - 配置项内容
** 输	 出: 
** 全局变量: 
...
/*********************************************************************************************************
** 函数名称: netsnmp_clear_user_target
** 功能描述: 用来释放在 user_target 相关的配置项数据的处理函数中申请的资源
** 输	 入: 
** 输	 出: 
** 全局变量: 
** 调用模块: 
...
/*********************************************************************************************************
** 函数名称: netsnmp_register_service_handlers
** 功能描述: 为当前系统注册和服务相关的配置文件的配置项的数据处理函数
** 输	 入: 
** 输	 出: 
** 全局变量: 
** 调用模块: 
