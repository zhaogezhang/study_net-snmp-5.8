...
/*********************************************************************************************************
** 函数名称: register_default_handlers
** 功能描述: 为当前系统注册默认的配置文件的配置项处理函数
** 输	 入: 
** 输	 出: 
** 全局变量: 
** 调用模块: 
...
/*********************************************************************************************************
** 函数名称: snmp_close
** 功能描述: 从当前 snmp 会话链表中关闭指定的会话并释放其资源
** 输	 入: session - 指定的会话指针
** 输	 出: 1 - 执行成功
**         : 0 - 执行失败
** 全局变量: 
 ...
 */
/*********************************************************************************************************
** 函数名称: snmp_duplicate_objid
** 功能描述: 申请一个新的内存并把指定的 oid 信息复制到这块内存中，然后返回这块内存首地址
** 输	 入: objToCopy - 需要复制到 oid 数据地址
**         : objToCopyLen - 需要复制的 oid 数据长度
** 输	 出: oid * - 成功申请并复制的 oid 数据
**         : NULL - 复制失败
** 全局变量: 
** 调用模块: 
*********************************************************************************************************/
...
/*********************************************************************************************************
** 函数名称: snmp_init_statistics
** 功能描述: 初始化当前系统数据统计功能模块数据结构
** 输	 入: 
** 输	 出: 
** 全局变量: 
** 调用模块: 
